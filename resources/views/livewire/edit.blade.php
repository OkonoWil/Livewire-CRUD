    ...
    <div class="py-6">
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="overflow-hidden flex justify-between bg-green-300 shadow-sm sm:rounded-lg">
                ...
                <button wire:click='removeSuccess' class=" px-2"><svg class="w-10 h-10" viewBox="0 0 24 24" fill="none"
            ...
            <div class="overflow-hidden bg-white shadow-sm dark:bg-gray-800 sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form wire:submit='update' class="w-full">
                        <h1 class="py-3 text-2xl font-bold">Edit Todo</h1>
                        <div class="pt-2">
                        ...
                        <div class="pt-5">
                            ...
                            <textarea wire:model="form.description" id="description" cols="30" rows="10"
                                class="w-full rounded-md dark:bg-gray-800"></textarea>
                        ...
                        <div>
                            <button type="submit"
                                class="px-5 py-2 mt-4 text-white bg-green-400 rounded-lg">Update</button>
                        </div>
                    </form>
                </div>
            </div>
